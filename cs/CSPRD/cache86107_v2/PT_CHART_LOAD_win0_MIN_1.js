...
var oMyChart = glObjTr.oJet[sCntr];  var oChartDiv=getObj(sCntr);var sPathCSS = oChartDiv.getAttribute("PSS");var sPath = "";sPath =oChartDiv.getAttribute("PH");var nJetPath=sPath.indexOf("http");if(nJetPath==0)
{
...
};window.addEventListener('load', removeICChart_PSFT, false);function PivotGridChartLoad()
{
 var PGChartFld = 'win0' + 'PTPG_NUI_WRK_PTPG_NUCHART_FIELD'; ChartLoad(PGChartFld,0);}
