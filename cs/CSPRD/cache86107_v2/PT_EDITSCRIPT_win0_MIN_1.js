...
if (bReset_win0)
 ...
 if (isFModeLayout())
 {
 var objError = obj.parentElement.parentElement; objError.classList.add("psc_error"); }
 else
 {
 obj.PSsaveclass = obj.className; obj.className = "PSERROR"; }
 }
obj.setAttribute('aria-invalid',true);msg = PSmessageSubst_win0(msg, PSerror_win0.arguments, 2);if (isFModeLayout()) 
...
{
if (!isChanged(obj))
 return false;PSdeferError_win0(obj, "Cannot change current or history records unless in Correct History mode.");bReset_win0 = true;return true;}
